...
% Using Tension Equations to solve for Small-Pulley
...
pulleySheaveRadius = 0.01905;
pulleyAxleRadius = 0.0047625;
...
% Display our results.
fprintf("With the real Pulley and Z', the tension of rope 2 is approximately %f Newtons\n",Result(1))
fprintf("The tension of rope 3 is approximately %f Newtons\n",Result(2))
fprintf("The tension of rope 4 is approximately %f Newtons\n",Result(3))
fprintf('\n')
fprintf('The friction in pulley 2 is %f Newtons\n',friction(1))
fprintf('The friction in pulley 3 is %f Newtons\n',friction(2))
fprintf('The friction in pulley 4 is %f Newtons\n',friction(3))
fprintf('\n')
fprintf("The friction coefficent of pulley 2 is %f\n",coeff(1))
fprintf("The friction coefficent of pulley 3 is %f\n",coeff(2))
fprintf("The friction coefficent of pulley 4 is %f\n",coeff(3))
fprintf('\n')
fprintf("With the Small Pulley Approximation (SPA), the tension of rope 2 is approximately %f Newtons\n",Tension_2sol)
fprintf("With SPA, the tension of rope 3 is approximately %f Newtons\n",Tension_3sol)
fprintf("With SPA, the tension of rope 4 is approximately %f Newtons\n",Tension_4sol)